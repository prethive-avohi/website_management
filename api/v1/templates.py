...
GET /api/method/pdcms_app.api.v1.templates.get_template?name=Landing+Page
POST /api/method/pdcms_app.api.v1.templates.publish_template  (Admin only)
"""
import json
import frappe
from pdcms_app.api.response import success, error, not_found
