...
def trigger_generation(doctype: str, name: str) -> dict:
    ...
    job_map = {
        "CMS Page": "paideia_cms.jobs.ai_generation.run_page_generation",
        "CMS Blog": "paideia_cms.jobs.ai_generation.run_blog_generation",
        "CMS Course": "paideia_cms.jobs.ai_generation.run_course_generation",
    }
...
def trigger_translation(doctype: str, name: str, language: str) -> dict:
    ...
    frappe.enqueue(
        "paideia_cms.jobs.translation.run_translation",
        queue="long",
        timeout=300,
        doctype=doctype,
        name=name,
